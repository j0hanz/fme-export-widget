export default {
  ...
  loadingRepositories: "Läser repositorys…",
  ...
  noRepositoriesFound: "Inga repositorys hittades.",
  testConnectionFirst: "Testa anslutningen först",
  invalidEmail: "Ogiltig e‑postadress.",
  errorRepositories: "Kunde inte läsa repositorys.",
  ...
  maskEmailOnSuccessHelper:
    "Döljer större delen av e‑postadressen i orderbekräftelsen.",
