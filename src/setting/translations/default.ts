export default {
  ...
  missingRepository: "Välj ett workspace.",
  invalidRepository: "Det valda workspacet finns inte i listan.",
  ...
  loadingRepositories: "Läser workspaces…",
  ...
  availableRepositories: "Tillgängliga workspaces",
  mapConfiguration: "Kartinställningar",
  serverUrlPlaceholder: "https://fme.server.com",
  tokenPlaceholder: "Din API‑nyckel",
  repoPlaceholder: "Välj ett workspace",
  noRepositoriesFound: "Inga workspaces hittades.",
  testConnectionFirst: "Testa anslutningen först",
  invalidEmail: "Ogiltig e‑postadress.",
  errorRepositories: "Kunde inte läsa workspaces.",
  errorInvalidServerUrl: "Ogiltig URL.",
  errorTokenIsInvalid: "Ogiltig API‑nyckel.",
  errorRepositoryNotFound: "Det valda workspacet finns inte i listan.",
  repositoryNotAccessible:
    "Det valda workspacet är inte åtkomligt. Kontrollera behörigheter.",
