export default {
  ...
  jobDirectivesHelper:
    "Standardvärden för FME-jobb. Lämna fälten tomma för att använda standardvärdena. Värden i beställning/script har företräde.",
  ...
  maskEmailOnSuccess: "Dölj e‑post i framgångsvy",
