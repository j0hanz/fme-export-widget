export default {
  ...
  errValidateFail: "Servern ogiltig eller felaktig konfiguration",
  ...
  errNoUserEmail: "E-postadress krävs för e-postnotifiering",
  ...
  errorValidationFailed: "Servern ogiltig eller felaktig konfiguration",
  ...
  userEmailMissingError: "E-postadress krävs för e-postnotifiering",
  ...
  rateLimitExceeded: "För många förfrågningar. Vänligen vänta och försök igen",
  ...
  /* Inställningsledtrådar som används av delade valideringar */
  ...
  connectionSettingsHint:
    "Kontrollera anslutningsinställningarna i inställningspanelen",
